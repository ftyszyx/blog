...
from lanzou2.api.models import FileList, FolderList
from lanzou2.api.types import *
from lanzou2.api.utils import *
...
class LanZouCloud(object):
    ...
    def get_folder_info_by_url(self, share_url, dir_pwd='') -> FolderDetail:
        ...
        try:
            html = requests.get(share_url, headers=self._headers,verify=False).text
